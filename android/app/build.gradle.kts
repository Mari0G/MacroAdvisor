...
android {
    namespace = "dev.mari0g.macroadvisor"
    ...
    defaultConfig {
        applicationId = "dev.mari0g.macroadvisor"
    ...
    buildTypes {
        release {
            // Local release builds remain possible before a keystore is configured.
            // GitHub's stable-release workflow rejects this fallback before publishing.
