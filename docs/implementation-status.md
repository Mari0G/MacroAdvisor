...
| S-005 | F-002 | Merged | — | `test/src/features/dashboard/application/dashboard_controller_test.dart`, `test/src/features/dashboard/presentation/today_page_test.dart`, and `integration_test/mvp_critical_journey_test.dart` | Merged as `86508a1`; local-day selection, aggregation, reactive updates, localized empty/populated/incomplete states, and meal navigation are on `develop`. Goal progress is planned in F-004/S-011. |
| S-006 | F-002 | Blocked | `codex/slice6-goal-progress` | — | The branch is not merged to `develop`; its unmerged goal scope is deliberately superseded by F-004/S-011 and must not be merged as S-006. |
...
| S-012 | F-005 | In progress | `feat/s-012-image-retention` | [Privacy audit](f-005-privacy-audit.md), migration, capture, repository and localized UI tests | Review corrections add v1/v2 upgrades, discard cleanup, confirmation-setting races, deletion rollback/retry and 200% UI coverage. Full local gate passes. Android journey now covers file-backed reopen, opt-out and both deletion actions; Not run: no connected Android device or configured AVD on 2026-09-05. Draft PR #25 remains blocked on this environment-only acceptance evidence. |
